...
public class Defaults
{
    ...
    public static final int DefaultDurabilityNetheriteShield = 3554;	// New for MC 1.16.x
	...
	public static final int DefaultDurabilityOsmiumShield = 750;			// New in 1.6
	...
	public static final int DefaultDurabilityDragonboneShield = 3750;	// New in 2.2
