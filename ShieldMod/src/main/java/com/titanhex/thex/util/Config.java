package com.titanhex.thex.util;
...
public class Config
{
	...
	Config(ForgeConfigSpec.Builder builder)
	{
		...
		vanillaOnly = builder.
				...
				translation("config." + ModThexShields.ID + ".vanillaOnly").
		...
		forceDisableUncraftableTooltips = builder.
				...
				translation("config." + ModThexShields.ID + ".forceDisableUncraftableTooltips").
				define("forceDisableUncraftableTooltips", false);
		cooldownShieldBash = builder.
				comment("Cooldown period for Shield Bashes").
				translation("config." + ModThexShields.ID + ".cooldownShieldBash").
		...
		disableShieldBash = builder.
				...
				translation("config." + ModThexShields.ID + ".disableShieldBash").
		...
		durabilityWoodShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityWoodShield").
		...
		durabilityStoneShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityStoneShield").
		...
		durabilityIronShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityIronShield").
		...
		durabilityGoldShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityGoldShield").
		...
		durabilityDiamondShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityDiamondShield").
		...
		durabilityNetheriteShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityNetheriteShield").
		...
		durabilityObsidianShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityObsidianShield").
		...
		durabilityCopperShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityCopperShield").
		...
		durabilityTinShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityTinShield").
		...
		durabilityBronzeShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityBronzeShield").
		...
		durabilitySteelShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilitySteelShield").
		...
		durabilitySilverShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilitySilverShield").
		...
		durabilityLeadShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityLeadShield").
		...
		durabilityNickelShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityNickelShield").
		...
		durabilityInvarShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityInvarShield").
		...
		durabilityConstantanShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityConstantanShield").
		...
		durabilityPlatinumShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityPlatinumShield").
		...
		durabilityElectrumShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityElectrumShield").
		...
		durabilityManasteelShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityManasteelShield").
		...
		durabilityTerrasteelShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityTerrasteelShield").
		...
		durabilityElementiumShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityElementiumShield").
		...
		durabilityOsmiumShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityOsmiumShield").
		...
		durabilityLapisLazuliShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityLapisLazuliShield").
		...
		durabilityRefinedGlowstoneShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityRefinedGlowstoneShield").
		...
		durabilityRefinedObsidianShield = builder.
				...
				translation("config." + ModThexShields.ID + ".durabilityRefinedObsidianShield").
		...
		damageToFEMultiplier = builder.
				...
				translation("config." + ModThexShields.ID + ".damageToFEMultpier").
