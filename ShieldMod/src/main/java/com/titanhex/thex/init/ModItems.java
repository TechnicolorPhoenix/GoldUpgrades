...
import com.titanhex.thex.client.render.item.ItemStackTileEntityRendererSS;
import com.titanhex.thex.enchantment.EnchantmentSS;
import com.titanhex.thex.item.BasicShieldItem;
import com.titanhex.thex.item.ExternalModShieldItem;
import com.titanhex.thex.item.FEPoweredShieldItem;
import com.titanhex.thex.item.ObsidianShieldItem;
import com.titanhex.thex.item.ShieldBaseItem;
import com.titanhex.thex.item.SilverShieldItem;
import com.titanhex.thex.util.Constants;
import com.titanhex.thex.util.Defaults;
import com.titanhex.thex.util.ItemTierSS;
...
{
    public static ItemGroup groupSS = new ItemGroup("thexshields")
    {
        @Override
