...
public class ExternalModShieldItem extends BasicShieldItem
{
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
    {
    	...
    	{
    		tooltip.add(new TranslationTextComponent("tooltip." + ModThexShields.ID + ".cant_craft_missing_mods", I18n.get("mod." + ModThexShields.ID + "." + modName)).withStyle(TextFormatting.RED));
    	}
