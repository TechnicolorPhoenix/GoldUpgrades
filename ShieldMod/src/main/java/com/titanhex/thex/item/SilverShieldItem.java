...
public class SilverShieldItem extends BasicShieldItem implements IDamageShield
{
    ...
    {
    	tooltip.add(new TranslationTextComponent("tooltip." + ModThexShields.ID + ".on_block", I18n.get("tooltip." + ModThexShields.ID + ".shield_silver.desc")).withStyle(TextFormatting.GOLD));
    }
