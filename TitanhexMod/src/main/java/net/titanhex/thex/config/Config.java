package net.titanhex.thex.config;
...
public class Config {
    ...
    public static ConfigValue<Integer> hexDamageReduction;
    ...
    public static ConfigValue<Integer> hexDurability;
    ...
    public Config() {
        cfg = CommentedFileConfig
                .builder(new File(FMLPaths.CONFIGDIR.get().toString(), TitanhexMod.MOD_ID + "-common.toml")).sync()
                .autosave().build();
        cfg.load();
        oreConfig();
        shieldConfig();
    ...
    private void shieldConfig() {
        ...
        hexDamageReduction = getInt("hexDamageReduction", CATEGORY_SHIELD, 60,
        ...
        hexDurability = getInt("hexDurability", CATEGORY_SHIELD, 730, "The durability of the Hex Shield.");
