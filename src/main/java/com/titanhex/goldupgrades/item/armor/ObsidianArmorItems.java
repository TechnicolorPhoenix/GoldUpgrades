...
import com.titanhex.goldupgrades.item.custom.armor.ObsidianArmorItem;
...
public class ObsidianArmorItems {
    ...
    private static final Multimap<Attribute, Double> OBSIDIAN_BASE_ARMOR_BONUSES = HashMultimap.create();
    private static final Multimap<Attribute, Double> OBSIDIAN_UPGRADED_ARMOR_BONUSES = createHealthArmorBonuses(0.5);
    private static final Multimap<Attribute, Double> OBSIDIAN_POWER_ARMOR_BONUSES = createHealthArmorBonuses(2);
