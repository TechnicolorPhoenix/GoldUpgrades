...
public class CustomAttributeEffectArmor extends CustomEffectArmor {
    ...
    public CustomAttributeEffectArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Map<Effect, Integer> effects, Multimap<Attribute, Double> attributeBonuses, Properties builderIn) {
