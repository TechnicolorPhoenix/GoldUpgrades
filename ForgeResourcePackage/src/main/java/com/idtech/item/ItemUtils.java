...
public class ItemUtils {
    ...
    public static Item buildHexbowItem(String name, CreativeModeTab group){
        return new HexBow(new Item.Properties().tab(group)).setRegistryName(BaseMod.MODID, name);
    }
